...
export default function SiteDetailModal({ site, onClose }) {
  ...
  const handleExportPDF = () => {
    ...
    doc.text('GridSight Site Report', 20, 20)
    ...
    doc.text('Generated by GridSight - AI-Powered Site Discovery', 20, pageHeight - 10)
    doc.text(new Date().toLocaleDateString(), 170, pageHeight - 10)

    // Save
    doc.save(`GridSight_Site_${site.rank}_Report.pdf`)
  }
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title: `GridSight Site #${site.rank}`,
          text: shareText,
          url: shareUrl
        })
      } else {
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4" style={{ zIndex: 9999 }}>
      <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative" style={{ zIndex: 10000 }}>
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Detailed Scoring */}
          <div>
            <h3 className="text-lg font-bold text-gray-800 mb-4">📊 Detailed Scoring</h3>
          ...
          {site.explanation && (
            <div>
              <h3 className="text-lg font-bold text-gray-800 mb-3">🤖 AI Analysis</h3>
          ...
          {showFullReport && (
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 space-y-4">
              <h3 className="text-xl font-bold text-blue-900 mb-4">📋 Comprehensive Site Report</h3>
              ...
              <div>
                <h4 className="font-semibold text-blue-800 mb-2">✨ Key Strengths</h4>
              ...
              <div className="bg-white rounded-lg p-4 border border-blue-300">
                <h4 className="font-semibold text-blue-800 mb-3">📊 Detailed Metrics Analysis</h4>
              ...
              <div>
                <h4 className="font-semibold text-blue-800 mb-2">⚠️ Development Considerations</h4>
                <ul className="list-disc list-inside text-gray-700 space-y-1">
              ...
              <div className="bg-white rounded-lg p-4 border border-blue-300">
                <h4 className="font-semibold text-blue-800 mb-2">⚡ Energy Production Estimates</h4>
                <div className="space-y-3 text-sm text-gray-700">
                  ...
                  <div className="pt-2 border-t border-blue-200">
                    <p className="font-semibold text-green-700">
                      🌱 Environmental Impact (50-acre):
                    </p>
                    <p className="ml-2">
                      Estimated <strong>{Math.round(site.metrics.solar_irradiance * 50 * 0.15 * 365 * 0.5)}</strong> tons of CO₂
              ...
              <div>
                <h4 className="font-semibold text-blue-800 mb-2">🚀 Recommended Action Plan</h4>
          ...
          {/* Share Message */}
          {shareMessage && (
            <div className={`text-center py-2 px-4 rounded-lg ${shareMessage.includes('✓') ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
              {shareMessage}
            </div>
          )}
